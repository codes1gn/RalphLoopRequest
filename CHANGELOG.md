...
### Changed
- Added `TodoWrite` as a guardrail to reinforce checkpoint discipline and improve system stability
- Removed conversational fallback — checkpoints now require structured tool calls
- Added mock testing harness (`harness/checkpoint_harness.py`) for automated subagent-driven stress testing
...
- **Combined 372 treatment steps tested**: 100% checkpoint adherence across all step positions
